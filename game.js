...
function eatThemUp(){
	...
	function update(){
		...
		if(cube.x >= 480) cube.vx = -Math.abs(cube.vx) / 5;
		if(cube.y >= 380) cube.vy = -Math.abs(cube.vy) / 5;
		if(cube1.x < 0) cube1.vx = -Math.abs(cube1.vx) / 5;
		if(cube1.y < 0) cube1.vy = -Math.abs(cube1.vy) / 5;
		if(cube1.y >= 380) cube1.vy = -Math.abs(cube1.vy) / 5;
		if(cube1.x >= 480) cube1.vx = -Math.abs(cube1.vx) / 5;
        collis(player, cube);
        collis(player, cube1);
